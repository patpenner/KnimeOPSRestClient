 ...
 * @author Openphacts
 */
public class ConnectorNodePlugin extends Plugin {
    // The shared instance.
    private static ConnectorNodePlugin plugin;

    /**
     * The constructor.
     */
    public ConnectorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ConnectorNodePlugin getDefault() {
        return plugin;
    }
